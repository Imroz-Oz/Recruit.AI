  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <header className="text-center space-y-6 max-w-3xl mx-auto">
        <h2 className="text-5xl font-serif font-bold text-[#0f172a] italic">ATS Fortress</h2>
        <div className="flex justify-center">
          <div className="flex items-center gap-8 bg-white px-10 py-6 rounded-3xl shadow-xl shadow-indigo-500/5 border border-slate-300/5">
            <div className="text-center">
              <span className="block text-4xl font-serif font-bold text-indigo-electric">98%</span>
              <span className="text-base font-bold uppercase tracking-widest text-[#0f172a]/40">Readability</span>
            </div>
            <div className="w-px h-10 bg-[#1e293b]/5" />
            <div className="text-center">
              <span className="block text-4xl font-serif font-bold text-coral">0</span>
              <span className="text-base font-bold uppercase tracking-widest text-[#0f172a]/40">Shadow Blocks</span>
            </div>
            <div className="w-px h-10 bg-[#1e293b]/5" />
            <div className="text-center">
              <span className="block text-4xl font-serif font-bold text-emerald-500">Opt+</span>
              <span className="text-base font-bold uppercase tracking-widest text-[#0f172a]/40">Tier Status</span>
            </div>
          </div>
        </div>
        <p className="text-[#0f172a]/60 font-medium">Ensure your candidate’s profile never hits the automated rejection bin by following these battle-tested formatting rules.</p>
      </header>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        <div className="bg-white p-10 rounded-3xl border border-slate-300/5 shadow-sm space-y-10">
          <h3 className="text-2xl font-serif font-bold italic border-b border-slate-300/5 pb-6">Phase 1: Core Principles</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            {principles.map((p) => (
              <div key={p.title} className="space-y-3">
                ...
                <p className="text-base text-[#0f172a]/60 leading-relaxed font-medium">{p.desc}</p>
              </div>
            ))}
          </div>
        </div>

        <div className="bg-[#1e293b] text-white p-10 rounded-3xl shadow-2xl relative overflow-hidden flex flex-col">
              ...
              {rejectionTriggers.map((item, i) => (
                <div key={i} className="flex gap-4 p-5 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all group">
                  ...
                  <div className="space-y-2">
                    <p className="text-base font-bold uppercase tracking-widest text-red-300/60">Trigger</p>
                    <p className="text-base font-bold">{item.trigger}</p>
                    <div className="flex items-center gap-2 pt-2 border-t border-white/5">
                      <CheckCircle2 className="w-3 h-3 text-emerald-400" />
                      <p className="text-base text-white/50">{item.fix}</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="absolute -bottom-10 -right-10 w-56 h-64 bg-coral/10 rounded-full blur-[100px]" />
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        <div className="lg:col-span-4 bg-white p-8 rounded-3xl border border-slate-300/5 shadow-sm">
            ...
            {[
              ...
              <div key={i} className="flex items-center justify-between p-4 bg-warm-gray rounded-2xl group hover:bg-indigo-electric hover:text-white transition-all cursor-default">
                <span className="text-base font-bold flex items-center gap-3">
                  <span className="text-base opacity-40 font-mono">0{i+1}</span>
                  {section}
                </span>
        ...
        <div className="lg:col-span-8 p-1 relative group h-full">
          ...
          <div className="absolute inset-0 bg-indigo-electric rounded-3xl blur opacity-20 group-hover:opacity-40 transition-opacity duration-700" />
          ...
          <div className="relative h-full bg-white rounded-[2.2rem] p-10 flex flex-col justify-center border border-indigo-100">
            ...
            <p className="text-[#0f172a]/60 leading-relaxed mb-8 max-w-xl font-medium">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="p-6 rounded-2xl bg-emerald-50 border border-emerald-100 flex gap-4">
                ...
                <p className="text-base font-bold text-emerald-800 leading-relaxed italic">"Spearheaded cloud migration using AWS (EC2/S3) reducing latency by 40%."</p>
              </div>
              <div className="p-6 rounded-2xl bg-red-50 border border-red-100 flex gap-4 opacity-60">
                <XCircle className="w-5 h-5 text-red-500 shrink-0" />
                <p className="text-base font-bold text-red-800 leading-relaxed">"Knowledge of AWS, EC2, S3, Cloud Computing."</p>
              </div>
            </div>
            
            <button className="mt-10 self-start px-8 py-3 rounded-full bg-indigo-electric text-white font-bold text-base uppercase tracking-widest shadow-xl shadow-indigo-200">
