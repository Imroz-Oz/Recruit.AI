    ...
    <div className="min-h-screen bg-cream p-8 md:p-20 font-sans selection:bg-indigo-electric/10">
      <div className="max-w-3xl mx-auto space-y-12">
        {onBack && (
          <button 
            onClick={onBack}
            className="group flex items-center gap-2 text-midnight/40 hover:text-midnight transition-colors"
          >
        ...
        <header className="space-y-6">
          ...
          <h1 className="text-5xl font-serif font-bold text-midnight italic italic">Privacy <span className="text-indigo-electric">Protocol.</span></h1>
          <p className="text-midnight/40 font-bold uppercase tracking-[0.2em] text-xs">Last Updated: May 3, 2026</p>
        </header>

        <div className="prose prose-midnight max-w-none space-y-8 text-midnight/70 leading-relaxed font-medium">
          <section className="space-y-4">
            <h2 className="text-2xl font-serif font-bold text-midnight italic">1. Intelligence & Data Collection</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-serif font-bold text-midnight italic">2. Resume DNA Analysis</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-serif font-bold text-midnight italic">3. Cookies & Tracking</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-serif font-bold text-midnight italic">4. Your Rights</h2>
            <p>
        ...
        <footer className="pt-20 border-t border-midnight/5">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-midnight flex items-center justify-center text-white">
                <Lock className="w-5 h-5" />
              </div>
              <p className="text-[10px] font-bold text-midnight/40 uppercase tracking-widest leading-tight">
                Enterprise Grade Security<br/>AES-256 Encrypted
              </p>
            </div>
            <p className="text-[10px] font-medium text-midnight/30 italic">
